...
/**
 *
 * @author Cleiciane Soares
 */
public class SuperTrunfoN{
    ...
    public static void main(String[] args) {
        ...
        carta2.setVelocidade (9);
        carta2.setPeso (3);
        carta2.setNavegacao (7);
        
        Cartas carta3 = new Cartas();
        carta3.setNome ("Marie");
        carta3.setVelocidade (9);
        carta3.setPeso (3);
        carta3.setNavegacao (7);
        
        Cartas carta4 = new Cartas();
        carta4.setNome ("Cornelia");
        carta4.setVelocidade (9);
        carta4.setPeso (3);
        carta4.setNavegacao (7);
        ...
        for(int i = 0; i < jogo.size(); i++){
            ...
            System.out.println(jogo.get(i).getNome());
            System.out.println(jogo.get(i).getVelocidade());
            System.out.println(jogo.get(i).getPeso());
            System.out.println(jogo.get(i).getNavegacao());
